...
DEFAULT_NETWORK_DIR = Path(__file__).resolve().parents[1] / "data" / "full_network"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="", help="Defaults to --network-dir.")
...
def main() -> None:
    ...
    output_dir = Path(args.output_dir).resolve() if args.output_dir else Path(args.network_dir).resolve()
